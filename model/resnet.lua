...
local function createModel(opt)
   ...
   if opt.dataset == 'imagenet' then
      ...
      model:add(Convolution(124,64,7,7,2,2,3,3))
   ...
   elseif opt.dataset == 'cifar10' then
      ...
      model:add(Convolution(124,16,3,3,1,1,1,1))
      ...
      model:add(nn.View(3249*64):setNumInputDims(3))
      model:add(nn.Linear(3249*64, 1))
